...
class DipoleDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        image = TF.normalize(image, [0], [300]) 
        
        # v59 Head-to-Head: CNN uses native 256x256 patches. No resize needed.
        
        return {'image': image, 'mask': mask}

# --- GPU Augmentation ---
def augment_batch(images, masks):
    # Keep only HFlip to preserve N-S orientation
        ...
        with tqdm(total=n_train, desc=f'Epoch {epoch}/{epochs}', unit='img') as pbar:
            ...
            for i, batch in enumerate(train_loader):
                ...
                with torch.autocast(device.type, enabled=amp):
                    # v60 Stability: Softened Deep Supervision
                    ...
                    total_loss = (1.0 * loss4) + (0.1 * loss3) + (0.05 * loss2)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--checkpoint-dir', type=str, default='gs://pyro-models-us-hostproject1-355311/checkpoints/v60')
