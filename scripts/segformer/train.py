...
class DipoleDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        # SegFormer handles 256x256. No resize needed.
...
if __name__ == '__main__':
    ...
    parser.add_argument('--checkpoint-dir', type=str, default='gs://pyro-models-us-hostproject1-355311/checkpoints/v62_segformer')
    ...
    model = SegFormerWrapper(n_channels=1, n_classes=1).to(device)
