...
class DipoleDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        # Swin Transformer requires 224x224
        image = TF.resize(image, [224, 224])
        mask = TF.resize(mask.unsqueeze(0), [224, 224]).squeeze(0)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--checkpoint-dir', type=str, default='gs://pyro-models-us-hostproject1-355311/checkpoints/v58')
    ...
    model = SwinUNet(n_channels=1, n_classes=1).to(device)
