...
def predict_on_raster(input_raster_path, output_raster_path, model_path, batch_size=16):
    ...
    # v62: HRNetSegmentation
    model = HRNetSegmentation(n_channels=1, n_classes=1, pretrained=False)
    ...
    local_output = f"/tmp/output_hrnet_{os.path.basename(input_raster_path)}"
